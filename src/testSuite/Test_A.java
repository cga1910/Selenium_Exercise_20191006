...
public class Test_A extends Base {
	...
	// Make sure every visible link in the main menu can be clicked, and collect all page titles (to be checked in the next test)
	@Test (priority = 2)
	public void test02() throws InterruptedException {
		...
		// Only continue with the test if the number of links is correct (sometimes the page shows an additional "home" link, which seems to happen randomly)
